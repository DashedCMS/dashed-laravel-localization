...
```php
        'providers' => [
		// [...]
                Dashed\LaravelLocalization\LaravelLocalizationServiceProvider::class,
        ],
```
...
```php
        'aliases' => [
		// [...]
                'LaravelLocalization' => Dashed\LaravelLocalization\Facades\LaravelLocalization::class,
        ],
```
...
Otherwise, you can use `ConfigServiceProviders` (check <a href="https://raw.githubusercontent.com/dashed/laravel-localization/master/src/config/config.php">this file</a> for more info).
